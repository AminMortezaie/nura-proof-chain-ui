...
const styles = {
    ...
    inputStyle: "w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3",
    selectStyle: "block w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500",
